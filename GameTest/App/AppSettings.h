...
#define APP_VIRTUAL_WIDTH		(1024.0f)				// This will be the effective x resolution regardless of actual screen/window res.
#define APP_VIRTUAL_HEIGHT		(768.0f)				// This will be the effective y resolution regardless of actual screen/window res.
